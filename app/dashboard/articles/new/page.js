...
export default function NewArticlePage() {
  ...
  async function publishLink(e) {
    ...
    const { error } = await supabase.from("articles").insert({
      ...
      slug,
      category,
      content: sourceDescription || "Link post",
      post_type: "link",
    ...
    <div style={{ color: "#f5eded" }}>
      <div style={{ marginBottom: 28 }}>
        ...
        <p style={{ color: "#9b7474", maxWidth: 700 }}>
          Choose whether you want to publish a full written article or post an
          article link that users can open from your website.
        </p>
      </div>
      ...
      >
        <button
          ...
          style={mode === "written" ? activeTab : tab}
        >
          Written Article
        </button>
