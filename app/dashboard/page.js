      ...
      <div style={{
        ...
        <div style={card}>
          ...
          <div style={{ marginTop: "14px" }}>
            <Link href="/dashboard/articles/new" style={primaryBtn}>New Article</Link>
          </div>
        </div>

        <div style={card}>
          <div style={label}>Community</div>
          <div style={value}>Discuss</div>
          <p style={sub}>Comments and replies on articles.</p>
          <div style={{ marginTop: "14px" }}>
            <Link href="/articles" style={secondaryBtn}>Browse Articles</Link>
          </div>
        </div>

        <div style={card}>
          <div style={label}>Discover</div>
          <div style={value}>Top Liked</div>
          <p style={sub}>See what readers engage with most.</p>
          <div style={{ marginTop: "14px" }}>
            <Link href="/top-liked" style={secondaryBtn}>Open</Link>
          </div>
        </div>
      </div>
    </div>
