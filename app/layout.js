      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
            <Link href="/articles" style={topBtn}>Articles</Link>
            <Link href="/top-liked" style={topBtn}>Top Liked</Link>
          </div>
        </div>
      </header>
      ...
      <div style={{
        ...
        <aside style={{
          ...
          <nav style={{ display: "grid", gap: "10px" }}>
            <Link href="/dashboard" style={navBtn}>Overview</Link>
            <Link href="/dashboard/articles/new" style={navBtn}>Publish Article</Link>
            <Link href="/articles" style={navBtn}>Browse Articles</Link>
            <Link href="/top-liked" style={navBtn}>Top Liked</Link>
          </nav>
        </aside>
